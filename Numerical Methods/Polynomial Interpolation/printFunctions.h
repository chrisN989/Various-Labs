...
/**** maxError print function *********/

void printError(std::vector<double> E){
 //E -> max x, max y, poly(max x), f(max x)
 std::cout<<"The largest error occurs at x = "<<E[0]<<std::endl;
 std::cout<<"This yields a maximum error of:\n";
 std::cout<<"|"<<E[2]<<" + "<< abs(E[3])<<"| = "<< abs(E[2] - E[3])<<std::endl;
